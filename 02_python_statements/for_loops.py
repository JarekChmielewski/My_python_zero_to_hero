# for loop acts as iterator so it goes through items in a sequence or any iterable item so
...
# will be unpacking the tuple inside of sequence we can access items inside that tuple
